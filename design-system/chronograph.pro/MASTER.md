...
**Project:** Chronograph.pro
**Generated:** 2026-01-19 23:56:59
...
## Timer Display Mode (Fullscreen/Speaker)

For the main timer display, use monospace font for precise digit alignment:

### Timer Typography

```css
/* Timer digits - use monospace */
...
### Dark Mode Colors (Fullscreen)

| Role | Hex | Usage |
|------|-----|-------|
| Background | `#000000` | OLED black |
| Text (safe) | `#22C55E` | Green - time remaining |
| Text (warning) | `#EAB308` | Yellow - 5 min warning |
| Text (critical) | `#EF4444` | Red - under 1 min |
| Text (overtime) | `#EF4444` | Red flashing - negative time |
