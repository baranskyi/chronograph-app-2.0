...
<template>
  <Card class="timer-preview h-full flex flex-col py-0">
    <!-- No timer selected -->
    <div v-if="!selectedTimer" class="flex-1 flex items-center justify-center p-4">
    ...
    <template v-else>
      <!-- Timer name -->
      <CardHeader class="text-center py-4 px-4 border-b">
        <div class="text-xs text-muted-foreground uppercase tracking-wide font-medium">Preview</div>
        <CardTitle class="text-lg truncate">{{ selectedTimer.name }}</CardTitle>
        <div
