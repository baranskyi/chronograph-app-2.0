...
<template>
  <div class="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4">
    <div class="w-full max-w-md">
      ...
      <!-- Register Form -->
      <form @submit.prevent="handleRegister" class="bg-[#1a1a1a] rounded-xl p-8 shadow-xl">
        <!-- Email -->
        <div class="mb-6">
        ...
        <!-- Error Message -->
        <div v-if="localError || authStore.error" class="mb-6 p-3 bg-red-500/10 border border-red-500/30 rounded-lg">
          <p class="text-red-400 text-sm">{{ localError || authStore.error }}</p>
        </div>
