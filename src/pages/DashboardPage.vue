  ...
  <div class="min-h-screen bg-[#0f0f0f] text-white">
    ...
    <template v-else>
      ...
      <div class="flex h-[calc(100vh-3rem-3rem)]">
        <!-- LEFT: Preview Panel -->
        <div class="w-[280px] bg-[#1a1a1a] border-r border-[#2a2a2a] flex flex-col p-2">
        ...
        <div class="flex-1 flex flex-col bg-[#0f0f0f] p-2">
          ...
          <div class="flex-1 overflow-y-auto p-2 flex flex-col gap-2">
            ...
            >
              ...
              <!-- Duration -->
              <div class="text-sm font-mono font-bold ml-4">{{ formatDuration(timer.settings.duration) }}</div>
