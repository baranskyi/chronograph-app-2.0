    ...
    <template v-else>
      ...
      <div class="flex h-[calc(100vh-3rem-3rem)]">
        ...
        <div class="flex-1 flex flex-col bg-[#0f0f0f] py-4">
          ...
          <!-- Timer List -->
          <div class="flex-1 overflow-y-auto flex flex-col gap-2 mx-4">
            <div
        ...
        <div class="w-[280px] bg-[#1a1a1a] border-l border-[#2a2a2a] flex flex-col py-4">
          <!-- Messages Header -->
          <div class="h-12 border-b border-[#2a2a2a] flex items-center mb-2 mx-4">
          ...
          <!-- Quick Messages -->
          <div class="flex-1 py-4 overflow-y-auto mx-4">
